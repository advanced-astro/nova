...
<div class="not-prose">
	<PatternDemo
		title="MobileMenu"
		context="docs"
		component="MobileMenu.astro"
		withContainer
	>
		<MobileMenu />
		<p class="hidden md:block text-sm text-gray-500">The mobile menu is hidden at the `md` breakpoint. Resize your browser to see the preview.</p>
	</PatternDemo>
</div>
